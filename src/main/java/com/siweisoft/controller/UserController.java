...
public class UserController extends BaseController<User>{
    ...
    @Override
    protected PageInfo<User> findPage(User params, int pageSize, int pageIndex) {
        return new PageInfo<User>(10,10,10,null);
    }

    @Override
    protected List<Object> findAll(User params) {
        return null;
    }
}
