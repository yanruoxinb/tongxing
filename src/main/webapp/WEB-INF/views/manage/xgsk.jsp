...
<div class="contaner"  id="page9"style="width:86%;float:right;padding:0 35px;border:1px solid #ddd">
    ...
    <div class="section">
        <h3 class="baoxiao" style="text-align:center;padding:0 100px">收款详情</h3>
        <hr/>
        <form class="form-horizontal" role="form">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div>
                            <a href="sk.html"><button type="button" class="btn" style="background-color: #008cee;color: #fff;">确定</button></a>
