        ...
        <div id="table-responsive" class="table-responsive" style="margin-top:15px;">
          <%--  <table class="table table-bordered" id="deleteUserTable">
                ...
                <tr>
                    ...
                    <td>
                        <a href="tjyh.html"> <span class="left xg" style="width:33%!important;"><button class="btn btn-info" style="color:#ffffff"> 修改</button></span></a>
...
<script>
   $(function() {
       callSapiServer("/user/list",function(data){
           userBody1(data);
       },"GET",{username:"李威",true_name:"liwei",pageIndex : 2});
       var array = [
