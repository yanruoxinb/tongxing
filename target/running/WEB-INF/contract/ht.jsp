...
<!--         <div class="big_box" style="display:none;">
    ...
    <div class="table-responsive" style="margin-top:15px;">
        <table class="table table-bordered">
            <tr style="text-align:left">
                <td colspan="7">
                    <button type="button" class="btn btn-info" style="margin-right:10px;">配置</button>
                    <button type="button" class="btn btn-info" style="margin-right:10px;">结算进度</button>
                    <button type="button" class="btn btn-info" style="margin-right:10px;">开票收款</button>
                </td>
            </tr>
            <tbody>
            <tr>
    ...
    <div class="table-responsive" style="margin-top:15px;">
        <table class="table table-bordered">
            <caption style="    text-align: left;font-weight:700;margin-bottom:10px;">开票收款</caption>
            <tr style="text-align:left">
                <td colspan="12">
                    <button type="button" class="btn btn-info" style="margin-right:10px;">新增</button>
                    <button type="button" class="btn btn-info" style="margin-right:10px;">删除</button>
                    <button type="button" class="btn btn-info" style="margin-right:10px;">修改</button>
                </td>
            </tr>
            <tbody>
            <tr>
    ...
    <div class="table-responsive" style="margin-top:15px;">
        <table class="table table-bordered">
            <caption style="    text-align: left;font-weight:700;margin-bottom:10px;">结算进度</caption>
            <tbody>
            <tr>
                <td>结算类型</td>
                <td>期限</td>
