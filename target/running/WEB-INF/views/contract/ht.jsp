...
<div class="contaner" id="page2"
    ...
    <a id="btn1" href="{ctx}/index.jsp" style="left: -30px;padding: 17px 10px;float: left;position: relative;"> 首页
        / </a>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td style=" color:blue;cursor: pointer;" class="xq">
                            ...
                            <a href="htxqxg.jsp"><span class="right"><button class="btn btn-info"
                                                                             style="color: #ffffff">修改
                            </button></span></a>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>已审核</td>
                        <td>待审核</td>
                        <td style=" color:blue;cursor: pointer;" class="xq"><a href="htxq.jsp"><span class="left"><button
                                class="btn"> 详情
                        </button></span></a><a href="htxqxg.jsp"><span class="right"><button class="btn btn-info"
                                                                                             style="color: #ffffff">修改
                        </button></span></a></td>
                    </tr>
                    <tr>
                ...
                <div class="table-responsive htxq" style="margin-top:15px;">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>已审核</td>
                            <td>待审核</td>
                            <td style=" color:blue;cursor: pointer;" class="xq"><a href="/contract/go/detail?id=1"><span
                                    class="left"><button class="btn"> 详情</button></span></a><a href="htxqxg.jsp"><span
                                    class="right"><button class="btn btn-info" style="color: #ffffff">修改</button></span></a>
                            </td>
                        </tr>
