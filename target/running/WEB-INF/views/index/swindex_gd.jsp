...
<div class="main-container container-fluid" style="width: 1610px;float: right; padding-left: 0;">
            ...
            <div class="col-md-9" style="padding-right:10px;">
                <form id="form" action="post" style="overflow:hidden;">
                        ...
                        <div class="header bordered-palegreen">
                            ...
                            <div class="DTTT btn-group pull-left" style="margin-left:25px;">
                                ...
                                <a class="btn1" href="javascript:void(0)"
                                   style="left: -30px;padding: 5px 5px;float: left;position: relative;color:#008cee!important;font-weight:normal;">
                                    功能列表</a>
                            </div>
                            <div class="DTTT btn-group pull-right">
                                <a class="btn btn-default DTTT_button_print" id="operateMode_new" name="edit"
                                   title="View print view"
                                   style="margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;"
                                   href="swindex.html">
                                    <span>新增</span>
                                </a>
                                <a class="btn btn-default DTTT_button_copy" id="operateMode_release" name="send"
                                   style="margin: 0% 0%;margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;">
                                    <span> 保存</span>
                                </a>
                                <a class="btn btn-default DTTT_button_copy" id="operateMode_release1" name="send"
                                   style="margin: 0% 0%;margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;">
                                    <span> 发布</span>
                                </a>
                                <a class="btn btn-default DTTT_button_copy" id="operateMode_release2" name="send"
                                   style="margin: 0% 0%;margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;"
                                   href="swindex_hf.jsp">
                                    <span> 回访</span>
                                </a>
                                <a class="btn btn-default DTTT_button_copy" id="bnt" name="send"
                                   style="margin: 0% 0%;margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;"
                                   href="swindex_sh.jsp">
                                    <span> 审核</span>
                                </a>
                                </a>
                                <a class="btn btn-default DTTT_button_copy" id="bntgd" name="send"
                                   style="margin: 0% 0%;margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;background-color:#008cee!important"
                                   href="swindex_gd.jsp">
                                    <span>归档</span>
                                </a>
                                <a class="btn btn-default DTTT_button_print" id="operateMode_new2" name="edit1"
                                   title="View print view1"
                                   style="margin-left:10px;border-left:1px solid #ccc;background:#008cee;color:#fff;border-radius: 5px;">
                                    <span>作废</span>
                                </a>
                    ...
                    <fieldset id="fieldset" class="fieldset_taskinfo"
                              style="margin:15px 15px;    padding: 15px 15px;">
                        <legend style="color:#008cee;line-height:20px;">任务信息</legend>
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="taskNum" name="taskNum" placeholder="G201641396" disabled class=" right"
                                       readonly="true" style="height: 22px;width:128px;"/>
                                <p class="ma_t  ab" style="float: right;">任务编号：</p>
                            </div>
                            <div class="col-md-4">
                                <input id="createdPerson" name="createdPerson" placeholder="王蒙" disabled
                                       class=" right" style="height: 22px; width:128px;"/>
                                <p class="ma_t  ab" style="float: right;">创建人：</p>
                            </div>
                            <div class="col-md-4">
                                <input id="sendTime" name="sendTime" placeholder="2016/12/23" disabled
                                       class=" right" required="required" style="width: 180px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4" style="position:relative;">
                                ...
                                <input id="customerId" name="customerId" class=" right" required="required"
                                       style="height: 22px;" placeholder="北京建筑建材研究院" value="" disabled="disabled"/>
                            ...
                            <div class="col-md-4" style="position:relative;">
                                ...
                                <input id="taskName" name="taskName" class=" right" style="height: 22px;"
                                       placeholder="建筑建材搅拌站一号线" value="" disabled="disabled"/>
                                ...
                                <input id="status" name="status" class="textbox"
                            ...
                            <div class="col-md-4">
                                ...
                                <input id="executorId" name="executorId" class=" right" required="required"
                                       style="height: 22px;" placeholder="陈工" value="" disabled="disabled"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="province" name="province" placeholder="陕西省" disabled class=" right"
                                       required="required" style="height: 22px;"/>
                                <p class="ma_t  ab" style="float: right;">所在省市：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="country" name="country" placeholder="碑林区" disabled class="right"
                                       required="required" style="height: 22px;"/>
                                <p class="ma_t  ab" style="float: right;">所在区县：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="faultCategory" name="faultCategory" placeholder="零件损坏" disabled
                                       class=" right" style="height: 22px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="planArriveTime" name="planArriveTime" placeholder="2016/12/01" disabled
                                       class=" right" required="required" style="width: 180px;"/>
                                <p class="ma_t  ab" style="float: right;">计划到达时间：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="planFinishTime" name="planFinishTime" placeholder="2016/12/11" disabled
                                       class=" right" required="required" style="width: 180px;"/>
                                <p class="ma_t  ab" style="float: right;">计划完成时间：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="taskType" name="taskType" class=" right" placeholder="现场服务" disabled
                                       required="required" style="height: 22px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="level" name="level" class=" right" placeholder="一级" disabled
                                       style="height: 22px;"/>
                                <p class="ma_t  ab" style="float: right;">客户级别：</p>

                            </div>
                            <div class="col-md-4">
                                <input id="transportation" name="transportation" placeholder="出租车" disabled
                                       class=" right" required="required" style="height: 22px;"/>
                                <p class="ma_t  ab" style="float: right;">交通方式：</p>
                            </div>
                            <div class="col-md-4">
                                <input id="contactName" name="contactName" placeholder="孙站长" disabled class=" right"
                                       required="required" style="height: 22px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="position" name="position" placeholder="工程师" disabled class="right"
                                       required="required" style="height: 22px;"/>
                            ...
                            <div class="col-md-4">
                                <input id="fixedPhone" name="fixedPhone" placeholder="13587623678" disabled
                                       class=" right" style="height: 22px;" value=""/>
                                <p class="ma_t  ab" style="float: right;">联系电话：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="contactPhone" name="contactPhone" placeholder="113556546342" disabled
                                       class=" right" required="required" style="height: 22px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="charge" name="charge" placeholder="5000" disabled class=" right"
                                       required="required" style="height: 22px;"/>
                                <p class="ma_t  ab" style="float: right;">标准收费：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="workHours" name="workHours" placeholder="8" disabled class=" right"
                                       required="required" style="height: 22px; "/>
                                <p class="ma_t  ab" style="float: right;">标准工时：</p>
                            </div>

                            <div class="col-md-4">
                                <input id="loopTime" name="loopTime" placeholder="2" disabled class=" right"
                                       style="height: 22px;"/>
                        ...
                        <div class="row" style="margin-right:150px;">
                            <div class="col-md-4">
                                <input id="workHours1" name="workHours" placeholder="18" disabled class=" right"
                                       required="required" style="height: 22px; "/>
                ...
                <div class="lrzj_tabCard">
                    <div class="title cf">
                        ...
                        <ul class="title-list fr cf task_Info">
                            <li class="on IndexprojectDet">项目详情</li>
                            <li class="IndexprojectRec">往来记录</li>
                            <li class="IndexprojectBx">报销明细</li>
                            <li class="IndexprojectMon">收款记录</li>
                            <li class="IndexprojectSerRec">服务记录</li>
                        </ul>
                    </div>
                    <div class="product-wrap">
                        ...
                        <div class="fieldset2_xm">
                            ...
                            <fieldset id="fieldset2_xm" class="fieldset2_xm"
                                      style="height:auto;padding:0 0 0 15px ;">
                                <legend style="color:#008cee;line-height:20px;">项目详情</legend>


                                <div class="section"
                                     style="margin:0px 5px -20px 5px; position:relative;top:-35px;">
                                    <button type="button" class="btn btnpz btnstyle btn_ht_detail2"
                                            style="margin:10px 15px;float:right;background-color:#008cee;color:#fff;">
                                        合同详情
                                    </button>
                                    <div class="table-responsive" style="margin-top:15px;">
                                        <table class="table table-bordered"
                                               style="margin: 0 -5px;text-align:center;">
                                            <thead>
                                            <tr>
                                                <td>项目编号</td>
                                                <td>项目名称</td>
                            ...
                            <fieldset id="fieldset_htinfomation" class="fieldset_htinfomation">
                                ...
                                <fieldset id="fieldset" class="">
                                    ...
                                    <div style="text-align:center;" class="cont_ht">
                                        ...
                                        <label for="B_name"> 乙 方：<input type="text" id="B_name"
                                                                        value="上海思伟软件有限公司"
                                                                        disabled="disabled"></label>
                                        ...
                                        <label for="qx_date" class="qd_date">签订日期：<input type="text"
                                                                                         id="qx_date_y"
                                                                                         value="2016"
                                                                                         disabled="disabled">年<input
                                                type="text" id="qx_date_m" value="12"
                                                disabled="disabled">月<input type="text" id="qx_date_d"
                                                                            value="13"
                                                                            disabled="disabled">日</label>

                                        <label for="yxqx_date" class="yx_Date">有限期限：<input type="text"
                                                                                           id="qx_date_y"
                                                                                           value="2016"
                                                                                           disabled="disabled">年<input
                                                type="text" id="qx_date_m" value="12"
                                                disabled="disabled">月<input type="text" id="qx_date_d"
                                                                            value="13"
                                                                            disabled="disabled">日至<input
                                                type="text" id="yxqx_date_y" value="2017"
                                                disabled="disabled">年<input type="text" id="yxqx_date_m"
                                                                            value="12"
                                                                            disabled="disabled">月<input
                                                type="text" id="yxqx_date_d" value="12"
                                                disabled="disabled">日</label>
                                ...
                                <div class="big_box">
                                    <div class="table-responsive" style="margin-top:15px;">
                                        <table class="table table-bordered htbd" style="text-align:center;">
                                            <caption
                                                    style="    text-align: left;font-weight:700;margin-bottom:10px;">
                                                合同标的
                                            </caption>
                                            <tbody>
                                            <tr>
                        ...
                        <div class="  fieldset_bxmx">
                            ...
                            <fieldset id="" class="fieldset1  "
                                      style="margin:15px 15px;display:block;padding:15px 15px 0 15px;">
                            ...
                            <fieldset class="fieldset1"
                                      style="margin:15px 15px;display:block;padding:15px 15px;">
                        ...
                        <div class="  fieldset_fwjl">
                            ...
                            <fieldset id="fieldset" style="border-radius:5px; margin: 15px 15px;" class="">
                                ...
                                <div class="arcivePart" style="display:block!important;margin-top:-25px;">
                                    <div class="row change_mar rt1">
                                        <div class="col-md-9" style="margin-top:10px;">
                                            <p style="margin-top: 10px;">现场情况信息</p>
                                                    <textarea class="form-control" rows="3" id="liveSituation"
                                                              name="liveSituation" placeholder="现场情况信息"
                                    ...
                                    <div class="row rt1">
                                        <div class="col-md-9">
                                            <p style="margin-top: 10px;">服务记录</p>
                                                    <textarea class="form-control" rows="3" id="visiteRecord"
                                                              name="visiteRecord" placeholder="服务记录"
                                                              disabled="disabled"></textarea>
                                        </div>
                                    </div>
                                    <div class="row rt1">
                                    ...
                                    <div class="row change_mar rt1">
                                        <div class="col-md-9">
                                            <p style="margin-top: 10px;">处理结果</p>
                                                    <textarea class="form-control" rows="3" id="processResult"
                                                              name="processResult" placeholder="处理结果"
                                                              disabled="disabled"></textarea>
                                        </div>
                                    ...
                                    <div class="row change_mar rt1">
                                        <div class="col-md-9">
                                            <p>点评</p>
                                                    <textarea class="form-control" rows="3" id="processResult1"
                                                              name="processResult" placeholder="客户评价"
                                                              disabled="disabled"> 服务很热情，工作技能扎实。</textarea>
                                        </div>
                                    </div>
                                    <div class="row change_mar rt1 hf_info">
                                        <div class="col-md-9">
                                            <p>回访记录</p>
                                                    <textarea class="form-control" rows="3" id="taskChecked"
                                                              name="taskChecked"
                                                              placeholder="评价内容">客户对我们的服务很满意，有意长期合作</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row change_mar rt1 hf_info_suc">
                                        <div class="col-md-9">
                                            <p>回访记录</p>
                                                    <textarea class="form-control" rows="3" id="taskChecked"
                                                              name="taskChecked" placeholder="评价内容" disabled="disabled">客户对我们的服务很满意，有意长期合作</textarea>
                                        </div>
                                        <div class="col-md-2">
                            ...
                            <div class="img_bigimg">
                                ...
                                <div id="imgthumb_box" class="imgthumb_box">
                                    <a href="" class="thumblink" id="imglink1"><img
                                            src="../../images/thumb/2.jpg"/></a>
                                    <a href="" class="thumblink" id="imglink2"><img
                                            src="../../images/thumb/3.jpg"/></a>
                                    <a href="" class="thumblink" id="imglink3"><img
                                            src="../../images/thumb/4.jpg"/></a>
                                    <a href="" class="thumblink" id="imglink4"><img
                                            src="../../images/thumb/5.jpg"/></a>
                                </div>
                            </div>
                            <div id="ShowBolightBox2"
                                 style="display: none; width: 1932px; height: 100%;display:none;"></div>
                        </div>
                    </div>
                </div>
                <div class="arcivePart gd_info" style="display:block!important;">
                    <fieldset id="fieldset" style="border-radius:5px; margin: 15px 15px;" class="">
                        <legend style="color:#008cee;line-height:20px;">归档信息</legend>
                        <div class="row" style="position:relative;top:-20px;text-align:center">

                            <div class="task-check" style="margin-top:10px;padding-left:160px;">
                                <label class="le">
                                    <input class="isshow" name="isshow" type="checkbox">
                                    <span class="text">现场服务单</span>
                                </label>
                                <label class="le">
                                    <input class="issystem" name="issystem" type="checkbox" checked="checked"/>
                                    <span class="text">CFG文件已上传</span>
                                </label>
                                <label class="le">
                                    <input class="isindex" name="isindex" type="checkbox"/>
                                    <span class="text">调试安装单</span>
                                </label>
                                <label class="le">
                                    <input class="islist" name="islist" type="checkbox"/>
                                    <span class="text">定期服务单</span>
                                </label>
                            </div>
                        </div>
                        <div class="shenghe_btn">
                            <button type="button" class="btn"
                                    style="margin:10px 0;background-color: #008cee;color: #fff;" id="pass_GD">确认归档
                            </button>
                ...
                <div class="arcivePart gd_info_suc" style="display:none;">
                    <fieldset id="fieldset" style="border-radius:5px; margin: 15px 15px;" class="">
                        <legend style="color:#008cee;line-height:20px;">归档信息</legend>
                        <div class="row" style="position:relative;top:-20px;text-align:center">
                            ...
                            <div class="task-check" style="margin-top:10px;padding-left:160px;">
                                <label class="le">
                                    <input class="isshow" name="isshow" type="checkbox" checked="checked"
                                           disabled="disabled">
                                    <span class="text">现场服务单</span>
                                </label>
                                <label class="le">
                                ...
                                <label class="le">
                                    <input class="isindex" name="isindex" type="checkbox" disabled="disabled"/>
                                    <span class="text">调试安装单</span>
                                </label>
                                <label class="le">
                                    <input class="islist" name="islist" type="checkbox" disabled="disabled"/>
                                    <span class="text">定期服务单</span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="col-md-3">
                    ...
                    <div class="col-lg-12 col-xs-12 col-md-12" style="padding:0px;">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-themesecondary">
                                ...
                                <a href="dituall.html"><img src="../../image/iconfont-ditu001.png" alt=""
                                                            style="padding: 10px 10px;margin-right:30px;width:40px;height:40px;float:right;"></a>
                                ...
                                <div id="actionList">
                                    <div class="table-responsive" style="margin-top:15px;">
                                        <table class="table table-bordered">
                                            <thead>
                                            <tr>
                                                <td style="text-align: center;font-size:14px;font-weight:700;">姓名
                                                </td>
                                                ...
                                                <!--</td>-->
                                                <td style="text-align: center;font-size:14px;font-weight:700;    width: 30%;">
                                                    当前状态
                                                </td>
                                            </tr>
                                            </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><a
                                                        href="http://j.map.baidu.com/RHkqH" target="_blank">西安</a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><a
                                                        href="http://j.map.baidu.com/XOkqH" target="_blank">新疆</a>
                                                </td>
                                                <td style="text-align: center;">工作中</td>
                                            </tr>
                                            <tr>
                ...
                <div class="task-row row">
                    <div class="widget" style="margin-top: -30px!important;">
                        <div class="widget-header bordered-bottom bordered-themeprimary cor"
                            ...
                            <button type="button" class="btn"
                                    style="background-color: #008cee;color: #fff;border-radius:15px;line-height:14px;font-size:12px;margin-right:10px;">
                                搜索
                            </button>
                                ...
                                <div class="task-container">
                                    <ul class="tasks-list" id="task_list">
                                        <li id="41026" class="task-item">
                                            ...
                                            <div class="task-state change_p1 col-md-3"><span
                                                    class="label label-blue">牛军安</span></div>
                                    ...
                                    <div style="position:relative;top:390px;">
                                        <ul class="pagination" id="pagination1"
                                            style="    padding-left: 17px; text-align: center;">
                                            <li class="first disabled" jp-role="first" jp-data="1"><a
                                                    href="javascript:;">&lt;&lt;</a></li>
                                            <li class="prev disabled" jp-role="prev" jp-data="0"><a
                                                    href="javascript:;">&lt;</a></li>
                                            <li class="page active" jp-role="page" jp-data="1"><a
                                                    href="javascript:;">1</a></li>
                                            <li class="page" jp-role="page" jp-data="2"><a href="javascript:;">2</a>
                                            </li>
                                            <li class="page" jp-role="page" jp-data="3"><a href="javascript:;">3</a>
                                            </li>
                                            <li class="page" jp-role="page" jp-data="4"><a href="javascript:;">4</a>
                                            </li>
                                            <li class="page" jp-role="page" jp-data="5"><a href="javascript:;">5</a>
                                            </li>
                                            <li class="page" jp-role="page" jp-data="6"><a href="javascript:;">6</a>
                                            </li>
                                            <li class="next" jp-role="next" jp-data="2"><a href="javascript:;">
                                                &gt;</a></li>
                                            <li class="last" jp-role="last" jp-data="6635"><a href="javascript:;">
                                                &gt;&gt;</a></li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <!--Car Record 弹出框-->
            <div class="modal bs-example-modal-carRecord" tabindex="-1" id="bxModal" role="dialog"
            ...
            <!--Reimburse 弹出框-->
            <div class="modal bs-example-modal-ReimburseCheck" tabindex="-1" id="bxModal" role="dialog"
                 aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
