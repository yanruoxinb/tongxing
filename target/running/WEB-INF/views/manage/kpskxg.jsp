...
<a id="btn1" href="swindex.html"style="left: -30px;padding: 17px 10px;float: left;position: relative;" > 首页 / </a>
    ...
    <div class="section">
        <h3 class="baoxiao" style="padding:0 100px;">开票修改</h3>
        <hr/>
            ...
            <div class="row">
                <div class="col-sm-4 col-sm-offset-2">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control width" id="inputEmail3" placeholder="" value="收款">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control width" id="inputEmail3" placeholder="" value="50000">
                        </div>
                        <i class="items pull-left">*</i>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control width" id="inputEmail3" placeholder="" value="李会计">
                        </div>
                        <i class="items pull-left">*</i>
                    </div>
                ...
                <div class="col-sm-4 col-sm-offset-2">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control width" id="inputEmail3" placeholder="" value="12345678">
                        </div>
                        <i class="items pull-left">*</i>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="11" placeholder="" value="汇款">
                        </div>
                        <i class="items pull-left">*</i>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control width" id="inputEmail3" placeholder=""value="悟空">
                        </div>
                        <i class="items pull-left">*</i>
                    </div>
                </div>
